...
jQuery(document).ready(function () {
    ...
    jQuery('input#author,input#email,input#url').addClass('form-control');
    
    // here for each comment reply link of wordpress
    jQuery('.comment-reply-link').addClass('btn btn-pricing');
    
    // here for the submit button of the comment reply form
    jQuery('#commentsubmit').addClass('btn btn-pricing');
    ...
    // the search widget	
    jQuery('input.search-field').addClass('form-control');
    jQuery('input.search-submit').addClass('btn btn-pricing');
